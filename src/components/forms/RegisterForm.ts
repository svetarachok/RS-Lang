...
export class RegisterForm extends Form {
  ...
  constructor(formName: string, btnName: string) {
    ...
    this.password = createNode({ tag: 'input', classes: ['password-input'], atributesAdnValues: [['type', 'password'], ['placeholder', 'Длина пароля > 8 символов'], ['autocomplete', 'new-password'], ['data-name', 'Пароль']] }) as HTMLInputElement;
