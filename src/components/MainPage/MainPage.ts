...
export class MainPage {
  ...
  <section class="advantages-section">
    <div class="advantage_wrapper">
      <img src="" alt="" class="advantage-image">
  ...
  <section class="info-section">
    <div class="info-text-wrapper">
      <h3 class="info-header">Учись вместе с RS-LANG</h3>
      <ul class="info-list">
        <li class="info-text">
          <span class="material-icons-outlined info-text-icon">task_alt</span>
            Преимущество 1
        </li>
        <li class="info-text">
          <span class="material-icons-outlined info-text-icon">task_alt</span>
  ...
  <section class="team-section">
    ...
    <div class="team-members">
      <div class="team-member">
        ...
        <h4 class="team-member-name">Светлана</h4>
      ...
      <div class="team-member">
        <img src="" alt="" class="team-member-img">
        <h4 class="team-member-name">Евгений</h4>
      ...
      <div class="team-member">
        <img src="" alt="" class="team-member-img">
        <h4 class="team-member-name">Сергей</h4>
        <p class="member-duty">Developer, designer</p>
        <div class="member-actions">
          <ul>
